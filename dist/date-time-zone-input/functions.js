import { getDateFormat, getTimeFormat, getZoneFormat } from '../utilities/functions';
const FONT_SIZE = 14;
...
const getInputProperties = (setDate, setMilliseconds, setSeconds, setTime, setTwentyFour, setValues, setZone) => {
  ...
  if (setValues.changed && setValues.input.value !== '') {
    nWidth = getTextWidthEstimate(setValues.input.value, FONT_SIZE) / FONT_SIZE + PIXEL_TO_EM_FACTOR;
  } else {
    nWidth = getTextWidthEstimate(placeholder, FONT_SIZE) / FONT_SIZE + PIXEL_TO_EM_FACTOR;
  }

...
import React from 'react'; //  Custom Components
...
class DateTimeZonePicker extends React.Component {
  ...
  render() {
    ...
    return React.createElement("div", {
      ...
      labelZone: labelZone
    }, setDate && showDate && React.createElement(Calendar, {
      allowDate: setDate,
      ...
      year: year,
      showDate: showDate
    }), setTime && showTime && React.createElement(Clock, {
      allowClock: setTime,
      ...
      showTime: showTime
    }), setZone && showZone && React.createElement(Zones, {
      allowDate: setDate,
      allowTime: setTime,
      allowZone: setZone,
